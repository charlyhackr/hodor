...
desofuscar = __import__("desofuscar").desofuscar


page = "http://158.69.76.135/level5.php"
captcha = "http://158.69.76.135/tim.php"
...
while Gud < votos and falla < 100:
    try:
        ...
        f.write(res.content)
        f.close()
        desofuscar("captcha.png")
        my_data["captcha"] = \
            pytesseract.image_to_string(Image.open('desofuscar.png'))
...
print("por fin: {}/{} votos.".format(gud, votos))
